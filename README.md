...
Nevergrad has a mechanism for cheap constraints. We basically repeat mutations until we get a satisfiable point.
...
optimizer = ng.optimizers.OnePlusOne(instrumentation=2, budget=100)
recommendation = optimizer.optimize(square, list_of_cheap_positivity_constraints=[lambda x: x[0] - 1)
print(recommendation)  # optimal args and kwargs
