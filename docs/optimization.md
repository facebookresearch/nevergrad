...
print("My Pareto front:", [x[0][0] for x in f.random_pareto_front(9)])
print("My Pareto front:", [x[0][0] for x in f.domaincovering_pareto_front(9)])
print("My Pareto front:", [x[0][0] for x in f.losscovering_pareto_front(9)])
```
