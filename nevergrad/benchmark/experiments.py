...
def simple_tsp(seed: tp.Optional[int] = None, complex_tsp: bool = False) -> tp.Iterator[Experiment]:
    ...
    seedg = create_seed_generator(seed)
    optims = ["RotatedTwoPointsDE", "DiscreteLenglerOnePlusOne", "DiscreteDoerrOnePlusOne", 
              "DiscreteBSOOnePlusOne", "AdaptiveDiscreteOnePlusOne", "GeneticDE", "RotatedTwoPointsDE",
              "DE", "TwoPointsDE", "DiscreteOnePlusOne", "NGOpt38", "CMA", "MetaModel", "DiagonalCMA"]
