...
def discrete2(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    optims = ["NGO", "cameleon", "JNGO", "octopus", "FTNGO", "cameleon", "JNGO", "octopus", "FTNGO2", "CMA"] + sorted(
...
def discrete(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    optims = ["NGO", "FTNGO", "cameleon", "JNGO", "octopus", "FTNGO2", "CMA"] + sorted(
...
def deceptive(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    optims = ["NGO", "FTNGO", "cameleon", "JNGO", "octopus", "FTNGO2", "PSO", "MiniQrDE", "MiniLhsDE", "MiniDE", "CMA", "QrDE", "DE", "LhsDE"]
    functions = [
...
def parallel(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    optims = ["ScrHammersleySearch", "NGO", "FTNGO", "cameleon", "JNGO", "octopus", "FTNGO2", "CMA", "PSO", "NaiveTBPSA", "OnePlusOne", "DE", "TwoPointsDE"]
    functions = [
...
def multimodal(seed: Optional[int] = None, para: bool = False) -> Iterator[Experiment]:
    ...
    optims = ["NGO","FTNGO", "cameleon", "JNGO", "octopus", "FTNGO2", "NaiveTBPSA", "TBPSA",
...
def yabbob(seed: Optional[int] = None, parallel: bool = False, big: bool = False, noise: bool = False, hd: bool = False) -> Iterator[Experiment]:
    ...
    """
    seedg = create_seed_generator(seed)
    optims = ["NaiveTBPSA", "TBPSA", "NGO", "FTNGO", "cameleon", "JNGO", "octopus", "FTNGO2", "CMA", "PSO", "DE", "MiniDE", "QrDE", "MiniQrDE", "LhsDE", "OnePlusOne",
...
def illcondi(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    """
    seedg = create_seed_generator(seed)
    optims = ["NGO", "FTNGO", "cameleon", "JNGO", "octopus", "FTNGO2", "CMA", "PSO", "DE", "MiniDE", "QrDE", "MiniQrDE", "LhsDE", "OnePlusOne", "SQP", "Cobyla",
...
def illcondipara(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    """
    seedg = create_seed_generator(seed)
    optims = ["NGO", "FTNGO", "cameleon", "JNGO", "octopus", "FTNGO2", "CMA", "PSO", "DE", "MiniDE", "QrDE", "MiniQrDE", "LhsDE", "OnePlusOne",
              "TwoPointsDE", "OnePointDE", "AlmostRotationInvariantDE", "RotationInvariantDE",
              "Portfolio", "ASCMADEthird", "ASCMADEQRthird", "ASCMA2PDEthird", "CMandAS2", "CMandAS", "CM",
...
def constrained_illconditioned_parallel(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    """
    seedg = create_seed_generator(seed)
    optims = ["NGO", "FTNGO", "cameleon", "JNGO", "octopus", "FTNGO2", "CMA", "PSO", "DE", "MiniDE", "QrDE", "MiniQrDE", "LhsDE", "OnePlusOne", "SQP", "Cobyla", "Powell",
              "TwoPointsDE", "OnePointDE", "AlmostRotationInvariantDE", "RotationInvariantDE",
              "Portfolio", "ASCMADEthird", "ASCMADEQRthird", "ASCMA2PDEthird", "CMandAS2", "CMandAS", "CM",
              "MultiCMA", "TripleCMA", "MultiScaleCMA", "RSQP", "RCobyla", "RPowell", "SQPCMA"]
    functions = [
...
def noisy(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    """
    seedg = create_seed_generator(seed)
    optims = ["NGO", "FTNGO", "cameleon", "JNGO", "octopus", "FTNGO2"] + sorted(
...
def realworld(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    algos = ["NaiveTBPSA", "LargeScrHammersleySearch", "ScrHammersleySearch", "PSO", "OnePlusOne",
             "NGO","FTNGO", "cameleon", "JNGO", "octopus","FTNGO2", "CMA", "TwoPointsDE", "QrDE", "LhsDE", "Zero", "StupidRandom", "RandomSearch", "HaltonSearch",
...
def fastgames(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    algos = ["NaiveTBPSA", "ScrHammersleySearch", "PSO", "OnePlusOne",
             ...
             "RandomScaleRandomSearch", "MiniDE", "SplitOptimizer5", "NGO", "FTNGO", "cameleon", "JNGO", "octopus", "FTNGO2"]
...
def powersystems(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    algos = ["NaiveTBPSA", "ScrHammersleySearch", "PSO", "OnePlusOne",
             ...
             "NGO", "FTNGO", "cameleon", "JNGO", "octopus", "FTNGO2", "SplitOptimizer3", "SplitOptimizer13"]
    for budget in [1600, 3200, 6400, 12800]:
        for num_workers in [1, 10, 100]:
            if num_workers < budget:
                for algo in algos:
...
def powersystemsbig(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    seedg = create_seed_generator(seed)
    algos = ["NaiveTBPSA", "SQP", "Powell", "LargeScrHammersleySearch", "ScrHammersleySearch", "NGO", "FTNGO", "cameleon", "JNGO", "octopus", "FTNGO2", "PSO", "OnePlusOne",
             "CMA", "TwoPointsDE", "QrDE", "LhsDE", "Zero", "StupidRandom", "RandomSearch", "HaltonSearch",
...
def mlda(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    algos = ["NaiveTBPSA", "LargeScrHammersleySearch", "ScrHammersleySearch", "PSO", "OnePlusOne",
             "CMA", "TwoPointsDE", "QrDE", "LhsDE", "Zero", "StupidRandom", "RandomSearch", "HaltonSearch",
             "RandomScaleRandomSearch", "MiniDE", "NGO", "FTNGO", "cameleon", "JNGO", "octopus", "FTNGO2"]
    for budget in [25, 50, 100, 200, 400, 800, 1600, 3200, 6400, 12800]:
        for num_workers in [1, 10, 100]:
            if num_workers < budget:
                for algo in algos:
...
#     funcs += [_mlda.Landscape(transform) for transform in [None, "square", "gaussian"]]
#     seedg = create_seed_generator(seed)
#     algos = ["NaiveTBPSA", "ScrHammersleySearch", "PSO", "OnePlusOne", "NGO", "cameleon", "JNGO", "octopus", "CMA", "OnePointDE", "TwoPointsDE", "QrDE", "LhsDE",
...
def arcoating(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    algos = ["NaiveTBPSA", "Cobyla", "SQP", "Powell", "LargeScrHammersleySearch", "ScrHammersleySearch", "PSO",
             "OnePlusOne", "NGO", "FTNGO", "cameleon", "JNGO", "octopus", "FTNGO2", "CMA", "TwoPointsDE", "QrDE", "LhsDE", "Zero", "StupidRandom"]
...
def double_o_seven(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    for num_repetitions in [1, 10, 100]:
        for archi in ["mono", "multi"]:
            ...
            for optim in ["PSO", "NGO", "FTNGO", "cameleon", "JNGO", "octopus", "FTNGO2", "CMA", "DE", "TwoPointsDE", "TBPSA", "OnePlusOne", "Zero",
...
def multiobjective_example(seed: Optional[int] = None) -> Iterator[Experiment]:
    # prepare list of parameters to sweep for independent variables
    seedg = create_seed_generator(seed)
    optims = ["NaiveTBPSA", "PSO", "DE", "LhsDE", "RandomSearch", "NGO", "FTNGO", "cameleon", "JNGO", "octopus", "FTNGO2", "CMA", "OnePlusOne", "TwoPointsDE"]
