...
def gp_sota() -> tp.Dict[str, tp.Tuple[float]]:
    gp = {}
    gp["CartPole-v1"]=(-500., 100000.)
    gp["Acrobot-v1"]=(83.17, 200000.)
    gp["MountainCarContinuous-v0"]=(-99.31, 900000.)
    gp["Pendulum-v0"]=(154.36, 1100000.)
    gp["InvertedPendulumSwingupBulletEnv-v0"]=(-893.35, 400000.)
    gp["BipedalWalker-v3"]=(-268.85, 1100000.)
    gp["BipedalWalkerHardcore-v3"]=(-9.25, 1100000.)
    gp["HopperBulletEnv-v0"]=(-999.19, 1000000.)
    gp["InvertedDoublePendulumBulletEnv-v0"]=(-9092.17, 300000.)
    gp["LunarLanderContinuous-v2"]=(-287.58, 1000000.)
    return gp
                    ...
                    if k in title:
                        ...
                        plt.plot(  # Vertical line, showing the budget of the GP solution.
                            ...
                            [min(vals["loss"][indices]),
                             ...
                             max(vals["loss"][indices])], name_style[optim_name],
                            label="gp",
                        )
