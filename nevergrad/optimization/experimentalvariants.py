...
ProgONOPOInf = ConfSplitOptimizer(num_optims=10000, progressive=True, multivariate_optimizer=OptimisticNoisyOnePlusOne).set_name(
...
ProgODOPOInf = ConfSplitOptimizer(num_optims=10000, progressive=True, multivariate_optimizer=OptimisticDiscreteOnePlusOne).set_name(
