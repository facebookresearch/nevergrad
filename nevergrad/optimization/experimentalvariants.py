...
NGOptSingle9 = MultipleSingleRuns(num_single_runs=9, base_optimizer=NGOpt12).set_name("NGOptSingle9", register=True)
NGOptSingle16 = MultipleSingleRuns(num_single_runs=16, base_optimizer=NGOpt12).set_name("NGOptSingle16", register=True)
NGOptSingle25 = MultipleSingleRuns(num_single_runs=25, base_optimizer=NGOpt12).set_name("NGOptSingle25", register=True)
