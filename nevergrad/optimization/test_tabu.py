...
def test_fasttabu() -> None:
    d = 3
    for opt_name in ["DiscreteOnePlusOneT", "PortfolioDiscreteOnePlusOneT", "SADiscreteLenglerOnePlusOneLinAuto"]:
        instru = ng.p.Array(shape=(d,), lower=0, upper=1.).set_integer_casting()
        b = 2 ** d
