...
@pytest.mark.parametrize("budget_multiplier", [None, 10, 100, 1000, 10000])  # type: ignore
...
def test_ngopt(dim: int, budget_multiplier: tp.Optional[int], num_workers: int, bounded: bool, discrete: bool) -> None:
