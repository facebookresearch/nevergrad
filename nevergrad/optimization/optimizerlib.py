...
@registry.register
class AnisoEMNA(EMNA):
    """Simple Anisotropic Estimation of Multivariate Normal Algorithm (EMNA).
    """
...
@registry.register
class NaiveAnisoEMNA(AnisoEMNA):
    """Simple Anisotropic version of Estimation of Multivariate Normal Algorithm (EMNA).
       Noiseless implementation
    """
