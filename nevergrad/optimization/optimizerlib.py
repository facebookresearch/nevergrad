...
chainDEwithMetaRecentering = Chaining([LHSSearch, DE], ["num_workers"]).with_name("chainDEwithLHS", register=True)
chainDEwithMetaRecenteringsqrt = Chaining([LHSSearch, DE], ["sqrt"]).with_name("chainDEwithLHSsqrt", register=True)
chainDEwithMetaRecenteringdim = Chaining([LHSSearch, DE], ["dimension"]).with_name("chainDEwithLHSdim", register=True)
chainDEwithMetaRecentering30 = Chaining([LHSSearch, DE], [30]).with_name("chainDEwithLHS30", register=True)
...
chainBOwithMetaRecentering30 = Chaining([LHSSearch, BO], [30]).with_name("chainBOwithLHS30", register=True)
chainBOwithMetaRecenteringsqrt = Chaining([LHSSearch, BO], ["sqrt"]).with_name("chainBOwithLHSsqrt", register=True)
chainBOwithMetaRecenteringdim = Chaining([LHSSearch, BO], ["dimension"]).with_name("chainBOwithLHSdim", register=True)
chainBOwithMetaRecentering = Chaining([LHSSearch, BO], ["num_workers"]).with_name("chainBOwithLHS", register=True)
...
chainPSOwithMetaRecentering30 = Chaining([LHSSearch, PSO], [30]).with_name("chainPSOwithLHS30", register=True)
chainPSOwithMetaRecenteringsqrt = Chaining([LHSSearch, PSO], ["sqrt"]).with_name("chainPSOwithLHSsqrt", register=True)
chainPSOwithMetaRecenteringdim = Chaining([LHSSearch, PSO], ["dimension"]).with_name("chainPSOwithLHSdim", register=True)
chainPSOwithMetaRecentering = Chaining([LHSSearch, PSO], ["num_workers"]).with_name("chainPSOwithLHS", register=True)
...
chainCMAwithMetaRecentering30 = Chaining([LHSSearch, CMA], [30]).with_name("chainCMAwithLHS30", register=True)
chainCMAwithMetaRecenteringsqrt = Chaining([LHSSearch, CMA], ["sqrt"]).with_name("chainCMAwithLHSsqrt", register=True)
chainCMAwithMetaRecenteringdim = Chaining([LHSSearch, CMA], ["dimension"]).with_name("chainCMAwithLHSdim", register=True)
