...
DEwithLHS30 = chaining([LHSSearch, DE], [30])  # Runs LHSSearch with budget 30 and then DE.
PSOwithLHS30 = chaining([LHSSearch, PSO], [30])  # Runs LHSSearch with budget 30 and then DE.
