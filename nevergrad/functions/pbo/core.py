...
class PBOFunction(base.ExperimentFunction):
    ...
    def __init__(self, fid: int = 1, iid: int = 0, dim: int = 16, instrumentation: str = "Softmax") -> None:
        ...
        assert instrumentation in ["Softmax", "Unordered"], "The only valid options for 'instrumentation' are 'Softmax' and 'Unordered'"
...
class WModelFunction(base.ExperimentFunction):
    ...
    def __init__(self, base_function: str = "OneMax", iid: int = 0, dim: int = 16, dummy: float = 0, epistasis: int = 0,
                 neutrality: int = 0, ruggedness: int = 0, instrumentation: str = "Softmax") -> None:
