...
class Array(core.Parameter):
    ...
    def __init__(
        ...
        if init is not None:
            ...
            assert isinstance(shape, tuple) and all(isinstance(n, int) for n in shape), str(shape) + " incorrect:" + str(isinstance(shape, tuple)), str([isinstance(n, int) for n in shape]) 
